package com.example.daffa11rpl22020;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                  if (txtusername.getText().toString().equalsIgnoreCase("daffa") && txtpassword.getText().toString().equals("daffa")){
                    Intent in = new Intent(LoginActivity.this,MainMenuActivity.class);
                      Toast.makeText(LoginActivity.this, "Welcome daffa", Toast.LENGTH_SHORT).show();
                    startActivity(in);
                      finish();
        ...
        tvforgot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(LoginActivity.this, "Default username & password = daffa", Toast.LENGTH_SHORT).show();
            }
        });
